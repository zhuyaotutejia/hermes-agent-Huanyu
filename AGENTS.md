...
This project is indexed by GitNexus as **hermes-agent** (150358 symbols, 279845 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Hermes_cli area (4411 symbols) | `.claude/skills/generated/hermes-cli/SKILL.md` |
| Work in the Gateway area (4210 symbols) | `.claude/skills/generated/gateway/SKILL.md` |
| Work in the Tools area (3713 symbols) | `.claude/skills/generated/tools/SKILL.md` |
| Work in the Agent area (2658 symbols) | `.claude/skills/generated/agent/SKILL.md` |
| Work in the Run_agent area (945 symbols) | `.claude/skills/generated/run-agent/SKILL.md` |
| Work in the Scripts area (941 symbols) | `.claude/skills/generated/scripts/SKILL.md` |
| Work in the Ui area (875 symbols) | `.claude/skills/generated/ui/SKILL.md` |
| Work in the Tests area (667 symbols) | `.claude/skills/generated/tests/SKILL.md` |
| Work in the Platforms area (626 symbols) | `.claude/skills/generated/platforms/SKILL.md` |
| Work in the Cron area (444 symbols) | `.claude/skills/generated/cron/SKILL.md` |
| Work in the Store area (433 symbols) | `.claude/skills/generated/store/SKILL.md` |
| Work in the Electron area (376 symbols) | `.claude/skills/generated/electron/SKILL.md` |
| Work in the Components area (270 symbols) | `.claude/skills/generated/components/SKILL.md` |
| Work in the Hooks area (265 symbols) | `.claude/skills/generated/hooks/SKILL.md` |
| Work in the Ink area (264 symbols) | `.claude/skills/generated/ink/SKILL.md` |
| Work in the Cli area (255 symbols) | `.claude/skills/generated/cli/SKILL.md` |
| Work in the App area (217 symbols) | `.claude/skills/generated/app/SKILL.md` |
| Work in the Feishu area (198 symbols) | `.claude/skills/generated/feishu/SKILL.md` |
| Work in the Lsp area (175 symbols) | `.claude/skills/generated/lsp/SKILL.md` |
| Work in the Discord area (172 symbols) | `.claude/skills/generated/discord/SKILL.md` |
